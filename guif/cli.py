...
def build_parser() -> argparse.ArgumentParser:
    ...
    gated_rollback = ÷m-¢G§²ÚîÆ­yÓ"); export.add_argument("project"); export.add_argument("--target", default="generic"); export.add_argument("--output", type=Path); export.add_argument("--clean", action=argparse.BooleanOptionalAction, default=True)
